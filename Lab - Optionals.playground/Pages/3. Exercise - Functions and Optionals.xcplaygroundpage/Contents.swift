...
var newPerson = checkAge(ageString: "17")
var newPerson2 = checkAge(ageString: "18")
var newPerson3 = checkAge(ageString: "34e")
...
func inventoryChecker(keys: String) -> Double? {
    if let stock = stock[keys] {
        if stock > 0 {
            if let price = prices[keys] {
                return price
            }
            else {
                return nil
