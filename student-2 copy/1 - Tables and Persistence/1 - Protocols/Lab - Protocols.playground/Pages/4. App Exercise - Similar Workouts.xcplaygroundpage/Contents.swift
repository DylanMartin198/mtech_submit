...
var workout1: () = simpleWorkoutDescription(workout: RunningWorkout(distance: 2500.0, time: 500.0))
var workout2: () = simpleWorkoutDescription(workout: SwimmingWorkout(distance: 500.0, time: 500.0))
/*:
