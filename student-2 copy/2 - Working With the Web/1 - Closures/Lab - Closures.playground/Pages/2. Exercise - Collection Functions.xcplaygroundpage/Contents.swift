...
let storedCollection1 = ["Dylan", "Ethan", "Megan", "Brandon"].sorted(by: forwards(name1:name2:))
print(storedCollection1)
...
let storedCollection2 = ["Dylan", "Ethan", "Megan", "Brandon"]
let sortedTeam = storedCollection2.sorted()
print(sortedTeam)
...
let sortedCollection3 = sortedTeam
