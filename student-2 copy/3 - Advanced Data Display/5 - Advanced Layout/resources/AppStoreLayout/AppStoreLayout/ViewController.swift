...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(PromotedAppCollectionViewCell.self,
           forCellWithReuseIdentifier:
           PromotedAppCollectionViewCell.reuseIdentifier)
        ...
        let layout = UICollectionViewCompositionalLayout
           ...
           NSCollectionLayoutSection? in
               ...
               let lineItemHeight = 1 /
                   ...
                   let supplementaryItemContentInsets =
                      NSDirectionalEdgeInsets(top: 0, leading: 4, bottom: 0,
                      trailing: 4)
            ...
            case .promoted:
                ...
                let availableLayoutWidth =
                    ...
                    item.contentInsets = NSDirectionalEdgeInsets(top: 0, leading:
                       itemLeadingAndTrailingInset, bottom: 0, trailing:
                       itemLeadingAndTrailingInset)
           ...
           (collectionView, indexPath, item) -> UICollectionViewCell? in
            ...
            case .promoted:
                let cell =
                   ...
                   PromotedAppCollectionViewCell.reuseIdentifier, for:
                   indexPath) as! PromotedAppCollectionViewCell
