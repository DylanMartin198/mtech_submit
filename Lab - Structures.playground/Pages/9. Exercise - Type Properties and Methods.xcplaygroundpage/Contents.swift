 ...
 */
struct User {
    static var currentUser = User(userName: "Dylan Martin", email: "dylan.martin6529@stu.mtec.edu", age: 17)
    var userName: String
    var email: String
    var age: Int
...
var otherUser = User(userName: "John", email: "John.Smith@outlook.com", age: 26)
User.logIn(user: otherUser)
/*:
