...
func timeAdjust(_ time: String, _ hours: Int, _ minutes: Int, _ seconds: Int) -> String {
    var time = time
    var formated = time
    formated = "\(hours):\(minutes):\(seconds)"
    for index in formated {
        time += formated
    }
...
timeAdjust("01:00:00", 1, 30, 10)
 timeAdjust("18:22:30", 4, 60, 30)
 timeAdjust("00:00:00", 72, 120, 120)
