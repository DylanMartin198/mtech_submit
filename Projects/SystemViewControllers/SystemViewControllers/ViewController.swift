...
//
//  Created by Dylan Martin on 10/25/22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func shareButtonTapped(_ sender: UIButton) {
        ...
        let activityController = UIActivityViewController(activityItems: [image, "This is yummy food"], applicationActivities: nil)
    ...
    @IBAction func emailButtonTapped(_ sender: UIButton) {
        ...
        mailComposer.setToRecipients("martinDylan632@gmail.com")
