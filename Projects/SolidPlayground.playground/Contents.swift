...
// class personViewController: Person

// func addPerson: People
// add a person to list

// func updateList: People
// update the list to show new person and details

// func deletePerson: People
// delete designated person
