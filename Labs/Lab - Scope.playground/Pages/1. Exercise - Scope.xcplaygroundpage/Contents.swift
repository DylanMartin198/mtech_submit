...
print("The first x is called before the for loop and so is not used, and the new x value is += 1 so it will add up to 10, in the first question foo was defined in the loop so that value was used")
...
var newgreeting: () = greeting(greeting: nil, name: "Bob")
var newgreeting1: () = greeting(greeting: "Hi there", name: "sara")
print(newgreeting)
print(newgreeting1)
