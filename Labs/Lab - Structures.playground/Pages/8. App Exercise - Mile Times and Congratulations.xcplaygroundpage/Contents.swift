...
struct RunningWorkout {
    ...
    let distanceTraveled = distance / 1600
        return distanceTraveled * time
    }
}
var firstWorkout = RunningWorkout(distance: 1500.0, time: 5.0, elevation: 4000.0)
print(firstWorkout.averageMileTime)
...
var stepsToday = Steps(steps: 9999, goal: 10_000)
stepsToday.takeStep()
/*:
