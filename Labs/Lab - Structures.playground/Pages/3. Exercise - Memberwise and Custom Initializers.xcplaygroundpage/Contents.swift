...
var favoriteBook = Book(title: "Fabelhaven", author: "Brandon Mull", pages: 300, price: 25.0)
print("My favorite book is called \(favoriteBook.title) it was written by \(favoriteBook.author) and it has \(favoriteBook.pages) pages and only costs \(favoriteBook.price)!")
/*:
...
Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2000)
/*:
